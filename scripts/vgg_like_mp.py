...
from torch_scripts.prune.magnitude import Pruner
...
model.info = {
    "model": "VGG16",
    "data": "cifar10",
    "comment": "Magnitude prune, Adam + l2(2e-5) + drop(0.2), cosine lr scheduler",
    "status": "running"
}
...
pruner = Pruner(model, modules, opt, storage=storage)
