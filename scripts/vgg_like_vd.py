...
from torch_scripts.prune.var_dropout import VariationalDropout
...
vd = VariationalDropout(model, modules)
...
model.info = {
    "model": "VGG16",
    "data": "cifar10",
    "comment": "VD(logalpha, lambda=2e-5), Adam, cosine lr scheduler",
    "status": "running"
}
